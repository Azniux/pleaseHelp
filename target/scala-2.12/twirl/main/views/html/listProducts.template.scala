      ...
      <tbody>
        """),_display_(/*47.10*/for(p<-products) yield /*47.26*/ {_display_(Seq[Any](format.raw/*47.28*/("""
          """),format.raw/*48.11*/("""<tr>
            ...
            <td><a href=""""),_display_(/*61.27*/routes/*61.33*/.ShoppingCtrl.addToBasket(p.getId)),format.raw/*61.67*/(""""  class="btn btn-default btn-xs"><span class="glyphicon glyphicon-shopping-cart"></span></a></td>
          </tr>
        """)))}),format.raw/*63.10*/("""
